...
describe('Cloud Servers Create Page - Create NextGen Performance 1 Server', function () {

    it('should create a NextGen server using a performance 1 flavor #regression', function () {
        var server = { name: tf.nextgenPerformance1.name };
        ...
        serversCreatePage.createServer(tf.nextgenPerformance1);
