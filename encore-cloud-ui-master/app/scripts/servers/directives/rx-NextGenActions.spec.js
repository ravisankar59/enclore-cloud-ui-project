/* jshint node: true */
describe('Directive: NextGen Actions', function () {
    var el, scope, compile, rootScope,
        template = '<rx-next-gen-actions actions="actions.list" user="user" server="server"></rx-next-gen-actions>';
    ...
    beforeEach(function () {
        ...
        inject(function ($rootScope, $compile, $templateCache, $q, Encore, CloudUsers) {
            ...
            scope.actions = {
                'list': [
                    'createImage', 'attachVolume', 'deleteServer', 'rebootServer'
                ]
            };
    ...
    it('should contain a list of actions', function () {
        ...
        expect(actions.eq(0).text()).to.equal('Create Image');
    });
});
