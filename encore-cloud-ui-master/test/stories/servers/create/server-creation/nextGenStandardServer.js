...
describe('Cloud Servers Create Page - NextGen Standard Server Creation', function () {

    it('should create a NextGen server using a standard flavor #regression', function () {
        var server = { name: tf.nextgenStandard.name };
        ...
        serversCreatePage.createServer(tf.nextgenStandard);
