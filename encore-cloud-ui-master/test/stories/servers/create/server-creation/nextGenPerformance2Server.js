...
describe('Cloud Servers Create Page - Create NextGen Performance 2 Server', function () {

    it('should create a NextGen server using a performance 2 flavor #regression', function () {
        var server = { name: tf.nextgenPerformance2.name };
        ...
        serversCreatePage.createServer(tf.nextgenPerformance2);
