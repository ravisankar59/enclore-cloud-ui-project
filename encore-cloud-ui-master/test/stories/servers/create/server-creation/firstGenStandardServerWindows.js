...
describe('Cloud Servers Create Page - FirstGen Windows Server Creation', function () {

    it('should create a FirstGen windows server #regression', function () {
        var server = { name: tf.firstgenWindows.name };
        ...
        serversCreatePage.createServer(tf.firstgenWindows);
